...
public class Monster extends LivingCreature {
    ...
    public ArrayList<LootItem> getLootTable() {return LootTable;}

    // Setters
    public void setID(int ID) {this.ID = ID;}
    public void setName(String name) {this.Name = name;}
    public void setMaximumDamage(int MaximumDamage) {this.MaximumDamage = MaximumDamage;}
    public void setRewardExperiencePoints(int RewardExperiencePoints) {this.RewardExperiencePoints = RewardExperiencePoints;}
    public void setRewardGold(int RewardGold) {this.RewardGold = RewardGold;}

    public void setLootTable(ArrayList<LootItem> LootTable) {this.LootTable = LootTable;}
